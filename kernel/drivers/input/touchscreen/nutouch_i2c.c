...
#define X_MIN                                 0x00
#define Y_MIN                                 0x00
#define X_MAX                                 1320//0xFFF
#define Y_MAX                                 840//0xFFF
...
static int nutouch_suspend(struct i2c_client *client, pm_message_t mesg)
{
